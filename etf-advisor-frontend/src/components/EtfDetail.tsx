// Detail view for the selected ETF. Shows live market data, price chart,
// recommendation verdict, and recommendation history.
...
export default function EtfDetail({ etf, onWatchlistChanged }: Props) {
  ...
  return (
      <div className="card detail">
        ...
        {/* Price Chart */}
        <PriceChart recommendations={recommendations} />
