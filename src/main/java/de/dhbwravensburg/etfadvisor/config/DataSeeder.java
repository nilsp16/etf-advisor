...
public class DataSeeder {
    ...
    CommandLineRunner seedEtf(EtfRepository repository){
        return args -> {
            ...
            repository.save(new Etf(2L, "iShares Core MSCI World", "IE00B4L5Y983",
                            "IWDA", "USD", 0.20, 98.76,
                            "Accumulating", 78.40, 101.20, 62.3, "Physical","buy")
                    );

            repository.save(new Etf(3L, "Xtrackers MSCI Emerging Markets", "IE00BTJRMP35",
                            "XMME", "EUR", 0.18, 24.31,
                            "Accumulating", 19.80, 26.10, 4.1, "Physical","hold")
                    );

            repository.save(new Etf(4L, "iShares S&P 500", "IE0031442068",
                            "IUSA", "USD", 0.07, 45.67,
                            "Accumulating", 36.20, 47.90, 89.7, "Physical","buy")
                    );

            repository.save(new Etf(5L, "Amundi MSCI World", "LU1681043599",
                    "CW8", "EUR", 0.12, 412.30,
